...
export const ChatControls = ({
  ...
  return (
    <>
        ...
        >
          {selectedMedia.map((media, index) => (
            <View key={index} style={styles.imageWrapper}>
              ...
              <TouchableOpacity style={styles.removeImage} onPress={() => onRemoveMedia(index)}>
      ...
      <View
        style={[styles.container, !isKeyboardOpen ? { paddingBottom: 50 } : { paddingBottom: 12 }]}
      >
        <TouchableOpacity onPress={handlePlusPress} disabled={selectedMedia.length >= 5}>
          <Icon
            name="tab_plus"
