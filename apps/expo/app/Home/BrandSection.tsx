  ...
  const postings: Array<BrandPosting> = [
    {
      brand: {
        brand: 'Audi',
        imageUrl:
          'https://mkvfjhboywoocbqdzilx.supabase.co/storage/v1/object/public/images/brands/audi.png',
      },
    ...
    },
    {
      brand: {
        brand: 'Abarth',
        imageUrl:
          'https://mkvfjhboywoocbqdzilx.supabase.co/storage/v1/object/public/images/brands/abarth.jpeg',
      },
      onCardClick: () => console.log(),
    },
    {
      brand: {
        brand: 'Fiat',
        imageUrl:
          'https://mkvfjhboywoocbqdzilx.supabase.co/storage/v1/object/public/images/brands/fiat.png?t=2024-09-12T08%3A35%3A42.764Z',
      },
      onCardClick: () => console.log(),
    },
    {
    ...
    },
    {
      brand: {
        brand: 'Mercedes',
        imageUrl:
          'https://mkvfjhboywoocbqdzilx.supabase.co/storage/v1/object/public/images/brands/mercedes.png',
      },
      onCardClick: () => console.log(),
    },
    {
      brand: {
        brand: 'BMW',
        imageUrl:
          'https://mkvfjhboywoocbqdzilx.supabase.co/storage/v1/object/public/images/brands/bmw.jpeg',
      },
      onCardClick: () => console.log(),
    },
    {
      brand: {
        brand: 'IVECO',
        imageUrl:
          'https://mkvfjhboywoocbqdzilx.supabase.co/storage/v1/object/public/images/brands/iveco.jpeg',
      },
      onCardClick: () => console.log(),
    },
  ]
